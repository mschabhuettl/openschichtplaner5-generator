'use strict';
require('./service-families.cjs');
require('./team-scope.cjs');
...
(async () => {
  ...
  try {
    ...
    assert.match(await page.locator(selector).getAttribute('title'), /Vorschlag/);
    ...
    for(const suite of ['./weekly-contract.cjs','./all-proposals.cjs','./import-issues.cjs','./diagnostic-actions.cjs','./rest-defaults.cjs','./team-transfer.cjs','./staffing-gaps.cjs','./personal-work.cjs','./demand-board.cjs','./planning-controls.cjs','./weekend-summary.cjs','./missing-approvals.cjs','./guidance.cjs','./progress-view.cjs','./working-time-caps.cjs','./history-demand.cjs','./team-scope.ui.cjs','./replacement.cjs','./approval-reach.cjs','./approval-leverage.cjs','./service-families.ui.cjs','./quick-start.cjs']){
