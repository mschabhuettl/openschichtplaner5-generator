...
(async () => {
  ...
  try {
    ...
    const selector = '.matrix-cell[data-employee-id="sp5:employee:101"][data-function-id="sp5:function:302"][data-workplace-id="sp5:workplace:302"]';
    ...
    dated.employees[0].approvals = [{function_id:'sp5:function:302',workplace_id:'sp5:workplace:302',valid_from:'2026-01-01',valid_until:'2026-03-31',supervised:true}];
    ...
    partial.employees[0].approvals = [{function_id:'sp5:function:302',workplace_id:'sp5:workplace:302',valid_from:'2026-02-02',valid_until:'2026-02-03',supervised:true}];
    ...
    await page.waitForFunction(() => document.querySelector('.matrix-cell[data-employee-id="sp5:employee:101"][data-function-id="sp5:function:302"]').getAttribute('aria-pressed')==='false');
    await page.click(selector);
    ...
    assert(partialResult.employees[0].approvals.some(a=>a.valid_until==='2026-02-08'));
