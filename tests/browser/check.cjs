...
(async () => {
  ...
  try {
    ...
    for(const suite of ['./weekly-contract.cjs','./all-proposals.cjs','./import-issues.cjs','./diagnostic-actions.cjs','./rest-defaults.cjs','./team-transfer.cjs','./staffing-gaps.cjs','./personal-work.cjs','./demand-board.cjs','./planning-controls.cjs','./weekend-summary.cjs','./missing-approvals.cjs','./guidance.cjs','./progress-view.cjs']){
