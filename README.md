...
**Version 0.9.8** ergänzt geprüfte, dauerhafte Release-Downloads für Python und Docker. Die Ergebniszuordnungs- und Excel-Korrekturen aus 0.9.7 sind enthalten. Persönliche Dienstfreigaben bleiben der SP5-Standard; zusätzliche Qualifikationsanforderungen sind optional. [Änderungen und Aktualisierung](docs/release-0.9.8.md).
...
```sh
python -m pip install './openschichtplaner5_generator-0.9.8-py3-none-any.whl[web,sp5]'
sp5-generator serve --host 127.0.0.1 --port 8080 --state-dir ./generator-state
```
