...
**Version 0.9.5** weist ungültige, nicht-endliche Rechenzeitlimits vor dem Modellaufbau zurück. Die Prüfungen für beschädigte Projektübersichten aus 0.9.4 sind enthalten. Persönliche Dienstfreigaben bleiben der SP5-Standard; zusätzliche Qualifikationsanforderungen sind optional. [Änderungen und Aktualisierung](docs/release-0.9.5.md).
...
```sh
python -m pip install './openschichtplaner5_generator-0.9.5-py3-none-any.whl[web,sp5]'
sp5-generator serve --host 127.0.0.1 --port 8080 --state-dir ./generator-state
```
