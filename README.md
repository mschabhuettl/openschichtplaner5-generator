...
**Version 0.9.13** führt von personenbezogenen Prüfhinweisen direkt zur passenden Person und zeigt deren Namen statt der technischen Kennung. Automatische Vorprüfung, Sollstundenherkunft und geprüfte Release-Downloads sind enthalten. Persönliche Dienstfreigaben bleiben der SP5-Standard; zusätzliche Qualifikationsanforderungen sind optional. [Änderungen und Aktualisierung](docs/release-0.9.13.md).
...
```sh
python -m pip install './openschichtplaner5_generator-0.9.13-py3-none-any.whl[web,sp5]'
sp5-generator serve --host 127.0.0.1 --port 8080 --state-dir ./generator-state
```
