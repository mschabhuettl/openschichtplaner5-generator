...
```sh
python -m pip install './openschichtplaner5_generator-0.9.19-py3-none-any.whl[web,sp5]'
sp5-generator serve --host 127.0.0.1 --port 8080 --state-dir ./generator-state
```
